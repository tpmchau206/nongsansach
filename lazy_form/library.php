...
define("SMTP_UNAME", "ngochai777890@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "yjkonjbapbqqeoin"); //Password for SMTP authentication
